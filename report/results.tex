...
% TODO: what is sysbench? what are events/s? what is the transfer rate? throughput? updates? bandwidth?
...
% 1. explain what is iozone testing and what is plotted in this 3dplots
% 2. leave only a group of 4 3d plots
% 2. plot all the three envs for a fixed file size as a function of the stride (or viceversa?)

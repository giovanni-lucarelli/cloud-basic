...
\begin{frame}{Stress-ng: CPU}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{stress_ng_cpu_performance.png}
  \end{figure}
\end{frame}
...
\begin{frame}{Stress-ng: Memory}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{stress_ng_memory_performance.png}
  \end{figure}
  \centering{\alert{Asymmetry} between two time scales}
\end{frame}
...
\begin{frame}{IOZone: writing comparison}
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{writer_filesize_1024.png}
  \end{figure}
\end{frame}
